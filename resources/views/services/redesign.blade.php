...
@section('serviceHeading', 'Website Redesign')

@section('serviceSubHeading', 'A fresh look and feel')

@section('serviceInfo', 'Give your website the attention it deserves and improve your online presence.')
