...
<div class="webapp-page-section-1-wrapper">
    <div class="webapp-page-section-1">
        <div class="webapp-page-section-1-left">
            ...
            <p class="webapp-page-section-1-left-info">Could your business benefit from software to improve its processes and procedures? Such as order processing systems or customer management systems? Are you an entrepreneur with a great app idea? If you answered yes to any of these questions, talk to us today about developing a unique web application with us. Our team uses the latest web development tools and approaches and can work with you to create a state of the art web application.</p>
            ...
            @component('partials.webfeature', ['icon' => 'fab fa-vuejs', 'iconClass' => 'webfeature-icon', 'featureClass' => 'webfeature-mid', 'serviceTitle' => 'VueJs JavaScript Framework', 'serviceInfo' => "Vue JS is a frontend JavaScript framework which provides interactivity, elegance, and speed to your application. Vue JS is a modern framework designed to improve the user experience when working with application interfaces.", 'serviceLink' => "", 'serviceLinkClass' => ''])
            @endcomponent
