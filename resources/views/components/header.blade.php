<div class="header">
    ...
    <div class="sidenav" id="sidenav">
        <li class="sidenav-item" ><p class="sidenav-item-close" id="sideNavClose">Close X</p></li>
        ...
        <li class="sidenav-item" id="sideNavDropdownBtn"><p class="sidenav-item-link">Services</p>
